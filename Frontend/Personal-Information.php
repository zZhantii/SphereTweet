                ...
                <center>
                    <div class="settings shadow">
                        ...
                        <div class="settings_content">
                            <form method="POST" action="../Backend/perfil/modificarUsuario.php">
                                ...
                                <div class="pi-input pi-input-lg">
                                    ...
                                    <input type="text" name="numberPhone" maxlength="9" pattern="[0-9]{9}"
                                        value="<?php echo $numberPhone ?>" />
                                </div>
                                ...
                                <div class="pi-input pi-input-lgg">
                                    ...
                                    <input type="text" name="description" value="<?php echo $descripcion ?>" />
                                </div>
                            ...
                            if (isset($_GET['messageSuccess'])) {
                                if ($_GET['messageSuccess'] == 1) {
                                    echo "<span style='color:green'>Se ha modificado correctamente el perfil</span>";
                                } else {
                                    echo "<span style='color:red'>No se ha modificado correctamente el perfil</span>";
                                }
                            }
                            ?>
