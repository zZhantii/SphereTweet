<?php
$fecha = new MongoDB\BSON\UTCDateTime(new DateTime('01-01-2024'));
...
if (isset($_POST['nameSearch'])) {
    ...
    $resultado = $db->publicaciones->find([], ['sort' => ['fecha' => -1]]);
}
...
foreach ($resultado as $key) {
    ...
    $publicacion .= "<a href=" . url_base . "Backend/publicaciones/likeIndex.php?id=" . $key['_id'] . " style='color:#515365;'><li class='hover-orange'><i class='fa fa-heart'></i>" . count($key['likes']) . "</li></a>";
