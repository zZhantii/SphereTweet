...
<head>
    ...
    <title><?php echo $_SESSION['usuario'] ?> Photos - Social Network</title>
...
<body>
            ...
            <div class="row border-radius">
                <div class="feed">
                    <div class="feed_title">
                        <span><a href="profile.php"><b>Profile</b></a> | <a href="about.php"><b>About</b></a> | <a
                                href="photos.php" id="select_profile_menu"><b>Photos</b></a></span>
                    </div>
                </div>
            </div>
    ...
    <div class="mobilemenu">
        ...
        <div class="mobilemenu_profile">
            ...
            <div class="mobilemenu_profile">
                <img id="mobilemenu_profile_pic" src="<?php echo $fotoPerfil; ?>" /><br>
