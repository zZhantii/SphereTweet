                ...
                <center>
                    <div class="settings shadow">
                        ...
                        <div class="settings_content">
                            <form method="POST" action="../Backend/perfil/cambioContraseña.php">
                            ...
                            if (isset($_GET['messageSuccess'])) {
                                if ($_GET['messageSuccess'] == 1) {
                                    echo "<span style='color:green'>Se ha modificado correctamente la contraseña</span>";
                                }
                            } else if (isset($_GET['messageError'])) {
                                if ($_GET['messageError'] == 1) {
                                    echo "<span style='color:red'>Las contraseñas no coinciden</span>";
                                } else if ($_GET['messageError'] == 2) {
                                    echo "<span style='color:red'>La contraseña no puede ser igual al anterior</span>";
                                }
                            }
                            ?>
                        </div>
            ...
            <div class="row shadow">
                ...
                <div class="menusetting_contain">
                    <ul>
                        ...
                        <li>
                            <a href="Change-Password.php" id="settings-select">Change Password</a>
                        </li>
                    </ul>
                </div>
            </div>
